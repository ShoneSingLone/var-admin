...
// lets you call a css selector with a guard
            ...
            var utils = {
                ...
                defaults: function (obj1, obj2) {
                    ...
                    if (!obj2._defaults) {
                        ...
                        _.merge(newObj, defaults, cloned);
                    }
                    return newObj;
                },
        ...
        90: [function (require, module, exports) {
            var tree = require('../tr"../tree"              Visitor = require('./vis"./visitor"              logger = require('../lo"../logger"              utils = require('../ut"../utils"            /* jshint loopfunc:true */
            ...
            ProcessExtendsVisitor.prototype = {
                ...
                checkExtendsForNonMatched: function (extendList) {
                    ...
                    extendList.filter(function (extend) {
                        ...
                        var selector = '_unkn"_unknown_"                     try {
                            selector = extend.selector.toCSS({});
                        } catch (_) {
                        }

                        if (!indices[extend.index + ' ' + " "ector]) {
                            indices[extend.index + ' ' + " "ector] = true;
                            logger.warn('exten"extend '"ector + '\' ha"' has no matches"                      }
                    });
                },
                doExtendChaining: function (extendsList, extendsListTarget, iterationCount) {
                    ...
                    var extendIndex, targetExtendIndex, matches, extendsToAdd = [], newSelector, extendVisitor = this,
                        selectorPath,
                    ...
                    if (extendsToAdd.length) {
                        ...
                        if (iterationCount > 100) {
                            var selectorOne = '{unab"{unable to calculate}"                         var selectorTwo = '{unab"{unable to calculate}"                         try {
                                selectorOne = extendsToAdd[0].selfSelectors[0].toCSS();
                                selectorTwo = extendsToAdd[0].selector.toCSS();
                            } catch (e) {
                            }
                            throw {
                                message: 'exten"extend circular reference detected. One of the circular extends is currently:"                                  selectorOne + ':exte":extend("ectorTwo + ')'
 ")"                        };
                        }
                ...
                visitRuleset: function (rulesetNode, visitArgs) {
                    ...
                    var matches, pathIndex, extendIndex,
                    ...
                    for (haystackSelectorIndex = 0; haystackSelectorIndex < haystackSelectorPath.length; haystackSelectorIndex++) {
                        ...
                        for (hackstackElementIndex = 0; hackstackElementIndex < hackstackSelector.elements.length; hackstackElementIndex++) {
                            ...
                            for (i = 0; i < potentialMatches.length; i++) {
                                ...
                                if (targetCombinator === '' && ""ckstackElementIndex === 0) {
                                    targetCombinator = ' ';
" "                             }
                ...
                isElementValuesEqual: function (elementValue1, elementValue2) {
                    if (typeof elementValue1 === 'strin"string"peof elementValue2 === 'strin"string"                       return elementValue1 === elementValue2;
                    }
                    ...
                    if (elementValue1 instanceof tree.Selector) {
                        ...
                        for (var i = 0; i < elementValue1.elements.length; i++) {
                            if (elementValue1.elements[i].combinator.value !== elementValue2.elements[i].combinator.value) {
                                if (i !== 0 || (elementValue1.elements[i].combinator.value || ' ') !" "(elementValue2.elements[i].combinator.value || ' ')) " "                                    return false;
                                }
                            }
        ...
        92: [function (require, module, exports) {
            var contexts = require('../co"../contexts"              Visitor = require('./vis"./visitor"              ImportSequencer = require('./imp"./import-sequencer"              utils = require('../ut"../utils"            var ImportVisitor = function (importer, finish) {
            ...
            ImportVisitor.prototype = {
                ...
                visitDeclaration: function (declNode, visitArgs) {
                    if (declNode.value.type === 'Detac"DetachedRuleset"                       this.context.frames.unshift(declNode);
                    } else {
                        visitArgs.visitDeeper = false;
                    }
                },
                visitDeclarationOut: function (declNode) {
                    if (declNode.value.type === 'Detac"DetachedRuleset"                       this.context.frames.shift();
                    }
                },
                visitAtRule: function (atRuleNode, visitArgs) {
        ...
        93: [function (require, module, exports) {
            var visitors = {
                Visitor: require('./vis"./visitor"              ImportVisitor: require('./imp"./import-visitor"              MarkVisibleSelectorsVisitor: require('./set"./set-tree-visibility-visitor"              ExtendVisitor: require('./ext"./extend-visitor"              JoinSelectorVisitor: require('./joi"./join-selector-visitor"              ToCSSVisitor: require('./to-"./to-css-visitor"         };
        ...
        94: [function (require, module, exports) {
            var Visitor = require('./vis"./visitor"            var JoinSelectorVisitor = function () {
                this.contexts = [[]];
                this._visitor = new Visitor(this);
            };
        ...
        96: [function (require, module, exports) {
            var tree = require('../tr"../tree"              Visitor = require('./vis"./visitor"            var CSSVisitorUtils = function (context) {
                this._visitor = new Visitor(this);
            ...
            ToCSSVisitor.prototype = {
                ...
                visitAtRuleWithoutBody: function (atRuleNode, visitArgs) {
                    ...
                    if (atRuleNode.name === '@char"@charset"                       // Only output the debug info together with subsequent @charset definitions
                        // a comment (or @media statement) before the actual @charset atrule would
                        // be considered illegal css as it has to be on the first line
                        if (this.charset) {
                            if (atRuleNode.debugInfo) {
                                var comment = new tree.Comment('/* ' "/* "uleNode.toCSS(this._context).replace(/\n/g, '') + ""*/\n" */\n"                              comment.debugInfo = atRuleNode.debugInfo;
                ...
                checkValidNodes: function (rules, isRoot) {
                    ...
                    for (var i = 0; i < rules.length; i++) {
                        ...
                        if (isRoot && ruleNode instanceof tree.Declaration && !ruleNode.variable) {
                            throw {
                                message: 'Prope"Properties must be inside selector blocks. They cannot be in the root"                             index: ruleNode.getIndex(),
                                filename: ruleNode.fileInfo() && ruleNode.fileInfo().filename
                            };
                        }
                        if (ruleNode instanceof tree.Call) {
                            throw {
                                message: 'Funct"Function '"eNode.name + '\' is"' is undefined"                             index: ruleNode.getIndex(),
                                filename: ruleNode.fileInfo() && ruleNode.fileInfo().filename
                            };
                        }
                        if (ruleNode.type && !ruleNode.allowRoot) {
                            throw {
                                message: ruleNode.type + ' node" node returned by a function is not valid here"                             index: ruleNode.getIndex(),
                                filename: ruleNode.fileInfo() && ruleNode.fileInfo().filename
                            };
                        }
                    }
                ...
                _compileRulesetPaths: function (rulesetNode) {
                    if (rulesetNode.paths) {
                        rulesetNode.paths = rulesetNode.paths
                            .filter(function (p) {
                                var i;
                                if (p[0].elements[0].combinator.value === ' ') {" "                                   p[0].elements[0].combinator = new (tree.Combinator)('');
""                              }
        ...
        97: [function (require, module, exports) {
            var tree = require('../tr"../tree"            var _visitArgs = {visitDeeper: true},
                _hasIndexed = false;
            ...
            function indexNodeTypes(parent, ticker) {
                ...
                for (key in parent) {
                    ...
                    child = parent[key];
                    switch (typeof child) {
                        case 'funct"function"                         // ignore bound functions directly on tree which do not have a prototype
                            // or aren't nodes
                            if (child.prototype && child.prototype.type) {
                                child.prototype.typeIndex = ticker++;
                            }
                            break;
                        case 'objec"object"                         ticker = indexNodeTypes(child, ticker);
                            break;
            ...
            Visitor.prototype = {
                visit: function (node) {
                    ...
                    if (!func) {
                        fnName = 'visit"visit"e.type;
                        func = impl[fnName] || _noop;
                        funcOut = impl[fnName + 'Out']"Out"noop;
...
// https://github.com/tildeio/rsvp.js/blob/cddf7232546a9cf858524b75cde6f9edf72620a7/lib/rsvp/asap.js
    ...
    ;    }, {}],
        100: [function (require, module, exports) {
            var clone = (function () {
                'use s"use strict"               function _instanceof(obj, type) {
                ...
                function clone(parent, circular, depth, prototype, includeNonEnumerable) {
                    if (typeof circular === 'objec"object"                       depth = circular.depth;
                    ...
                    var useBuffer = typeof Buffer != 'undef"undefined"                   if (typeof circular == 'undef"undefined"                     circular = true;

                    if (typeof depth == 'undef"undefined"                     depth = Infinity;
                    ...
                    function _clone(parent, depth) {
                        ...
                        var child;
                        var proto;
                        if (typeof parent != 'objec"object"                           return parent;
                        }
                        ...
                        if (_instanceof(parent, nativeMap)) {
                            ...
                            if (typeof prototype == 'undef"undefined"                               proto = Object.getPrototypeOf(parent);
...
// private utility functions
                ...
                function __isDate(o) {
                    return typeof o === 'objec"object"objToStr(o) === '[obje"[object Date]"             }

                clone.__isDate = __isDate;

                function __isArray(o) {
                    return typeof o === 'objec"object"objToStr(o) === '[obje"[object Array]"             }

                clone.__isArray = __isArray;

                function __isRegExp(o) {
                    return typeof o === 'objec"object"objToStr(o) === '[obje"[object RegExp]"             }
...
"g"                 if (re.ignoreCase) flags += 'i';
"i"                 if (re.multiline) flags += 'm';
"m"                 return flags;
                }
            ...
            if (typeof module === 'objec"object"dule.exports) {
                module.exports = clone;
            }

        }, {}],
        101: [function (require, module, exports) {
            'use s"use strict"           var asap = require('asap/"asap/raw"            function noop() {
            }
...
// extract them to here.
            ...
            function Promise(fn) {
                if (typeof this !== 'objec"object"                   throw new TypeError('Promi"Promises must be constructed via new"              }
                if (typeof fn !== 'funct"function"                   throw new TypeError('Promi"Promise constructor's argument is not a function"              }
                this._40 = 0;
                this._65 = 0;
                this._55 = null;
                this._72 = null;
            ...
            function resolve(self, newValue) {
                ...
                if (newValue === self) {
                    return reject(
                        self,
                        new TypeError('A pro"A promise cannot be resolved with itself."                 );
                }
                if (
                    newValue &&
                    (typeof newValue === 'objec"object"peof newValue === 'funct"function"             ) {
                    ...
                    if (
                        ...
                        finale(self);
                        return;
                    } else if (typeof then === 'funct"function"                       doResolve(then.bind(newValue), self);
                        return;
                    }
                }
                self._65 = 1;
            ...
            function Handler(onFulfilled, onRejected, promise) {
                this.onFulfilled = typeof onFulfilled === 'funct"function"ulfilled : null;
                this.onRejected = typeof onRejected === 'funct"function"ejected : null;
        ...
        102: [function (require, module, exports) {
            'use s"use strict"/This file contains the ES6 extensions to the core Promises/A+ API

            var Promise = require('./cor"./core.js"            module.exports = Promise;
...
""            function valuePromise(value) {
            ...
            Promise.resolve = function (value) {
                ...
                if (value === '') re""rn EMPTYSTRING;

                if (typeof value === 'objec"object"peof value === 'funct"function"                   try {
                        var then = value.then;
                        if (typeof then === 'funct"function"                           return new Promise(then.bind(value));
                        }
                    } catch (ex) {
                        return new Promise(function (resolve, reject) {
                            reject(ex);
            ...
            Promise.all = function (arr) {
                ...
                return new Promise(function (resolve, reject) {
                    ...
                    function res(i, val) {
                        if (val && (typeof val === 'objec"object"peof val === 'funct"function"                            if (val instanceof Promise && val.then === Promise.prototype.then) {
                                while (val._65 === 3) {
                                    val = val._55;
                                }
                                ...
                                var then = val.then;
                                if (typeof then === 'funct"function"                                   var p = new Promise(then.bind(val));
                                    p.then(function (val) {
                                        res(i, val);
                                    }, reject);
                                    return;
            ...
            Promise.prototype['catch"catch"nction (onRejected) {
...
// should work in any browser without browserify
            ...
            if (typeof Promise.prototype.done !== 'funct"function"               Promise.prototype.done = function (onFulfilled, onRejected) {
...
// not "use strict" so we can declare global "Promise"
            ...
            var asap = require('asap'"asap"            if (typeof Promise === 'undef"undefined"               Promise = require('./lib"./lib/core.js" ;            require('./lib"./lib/es6-extensions.js" ;        }

            require('./pol"./polyfill-done.js"        }, {"./lib/core.js": 101, "./lib/es6-extensions.js": 102, "./polyfill-done.js": 103, "asap": 98}]
    }, {}, [2])(2)
});;