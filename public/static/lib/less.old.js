...
debugInfo.asComment = function (ctx) {
    return ctx.debugInfo ? "/* line " + ctx.debugInfo.lineNumber + ", " + ctx.debugInfo.fileName + " */\n" : "";
};
        ...
        ParseTree.prototype.toCSS = function (options) {
            ...
            if (options.pluginManager) {
                ...
                for (var i_1 = 0; i_1 < postProcessors.length; i_1++) {
                    result.css = postProcessors[i_1].process(result.css, {
...
var Render = (function (environment, ParseTree, ImportManager) {
    var render = function (input, options, callback) {
        debugger;
        if (loadedFileContentsGlobalVarsContent) {
            input = loadedFileContentsGlobalVarsContent + input;
        }
    ...
    function loadStyleSheet(sheet, callback, reload, remaining, modifyVars) {
        ...
        fileManager
            ...
            .then(function (loadedFile) {
                if (sheet.id === "less-global-vars") {
                    /*add myself 的 加载方法*/
                    loadedFileContentsGlobalVarsContent = loadedFile.contents;
                    loadedFile.contents = "";
                }
 ...
 */
var loadedFileContentsGlobalVarsContent = "";
